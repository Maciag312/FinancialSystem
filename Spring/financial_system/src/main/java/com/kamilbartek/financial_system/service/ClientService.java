...
public class ClientService {
    ...
    Boolean newClient(String name, String surename, String username,String password, String phone_number,String adress, String country,String identity_card_number, Date date_of_birth, String email_address)
    {
     client = new Client();
    client.setName(name);
